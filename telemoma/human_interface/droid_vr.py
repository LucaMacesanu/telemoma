...
class VRPolicy(BaseTeleopInterface):
    def __init__(
        self,
    ...
    def _calculate_action(self, state_dict):
        ...
        robot_quat = np.array(state_dict["cartesian_position"][3:])
    ...
    def get_action(self, obs):
        ...
        obs_dict = {'cartesian_position': obs['right'][:-1], 'gripper_position': obs['right'][-1]}
        action.right = self._calculate_action(obs_dict)
